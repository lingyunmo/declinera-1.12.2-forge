...
public class BlockMint extends ElementsDeclineraMod.ModElement {
	@GameRegistry.ObjectHolder("declinera:mint")
	public static final Block block = null;
	public BlockMint(ElementsDeclineraMod instance) {
		super(instance, 19);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("declinera:mint", "inventory"));
	}
