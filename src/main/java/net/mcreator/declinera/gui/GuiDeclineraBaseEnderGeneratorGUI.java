...
public class GuiDeclineraBaseEnderGeneratorGUI extends ElementsDeclineraMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiDeclineraBaseEnderGeneratorGUI(ElementsDeclineraMod instance) {
		super(instance, 92);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("declinera:textures/declinera_base_ender_generator_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Energy storage:", 15, 43, -12829636);
			this.fontRenderer.drawString("Power generation:", 6, 25, -12829636);
			...
			}.getValue(new BlockPos((int) x, (int) y, (int) z), "Energy")) + "", 96, 43, -12829636);
			this.fontRenderer.drawString("" + (new Object() {
				public double getValue(BlockPos pos, String tag) {
					TileEntity tileEntity = world.getTileEntity(pos);
					if (tileEntity != null)
			...
			}.getValue(new BlockPos((int) x, (int) y, (int) z), "Generation")) + "", 96, 25, -12829636);
			this.fontRenderer.drawString("Ender Generator", 51, 7, -12829636);
			this.fontRenderer.drawString("Speed:0.002 DE/s", 6, 16, -12829636);
		}
